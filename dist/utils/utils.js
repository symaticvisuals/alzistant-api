...
exports.classResponse = exports.asyncMiddleware = exports.generateJwtToken = exports.verifyJwtToken = exports.verifyUserRole = exports.verifyCaretakerRole = exports.sendResponse = exports.errorHandler = exports.getMessageBody = void 0;
...
const verifyCaretakerRole = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.user) {
        return res.status(401).json({
            success: false,
            data: null,
...
exports.verifyCaretakerRole = verifyCaretakerRole;
const verifyUserRole = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.user) {
        return res.status(401).json({
            success: false,
            data: null,
